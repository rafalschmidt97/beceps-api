This repository is a part of **Beceps** project for [VAMK University](http://puv.fi/).

Created with Java and Micronaut. Client is available [here](https://github.com/rafalschmidt97/beceps-client).
