...
public class AddSetCommandHandler implements CommandHandler<AddSetResponse, AddSetCommand> {
  private final RoutineRepository sqlRoutineRepository;
  private final SetRepository setRepository;

  @Override
  public AddSetResponse handle(AddSetCommand command) {
    ...
    return new AddSetResponse(set.getId());
  }
}
